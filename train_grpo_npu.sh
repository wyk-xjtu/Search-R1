...
export SEARCH_R1_RAY_RESOURCE=${SEARCH_R1_RAY_RESOURCE:-NPU}
export SEARCH_R1_ATTENTION_IMPL=${SEARCH_R1_ATTENTION_IMPL:-sdpa}
...
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-nq-search-r1-grpo-qwen2.5-3b-em-npu}
